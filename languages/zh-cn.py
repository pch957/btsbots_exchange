...
'call auction will excute at block': '启动交易的区块号',
...
'Deposi currency': 'Deposi currency',
'Deposit': '转入',
'deposit': '充值',
'Deposit amount': '发送数量',
'Deposit currency': '发送资产',
'Description': '描述',
...
'Pay attention to our': 'Pay attention to our',
'Peeking at file': '选择文件',
'Place Order': '下单',
'place order': 'place order',
'PLS/BTSBOTS.PLS': 'PLS/BTSBOTS.PLS',
'PLS<->BTSBOTS.PLS': 'PLS<->BTSBOTS.PLS',
'PLS<>BTSBOTS.PLS': 'PLS<>BTSBOTS.PLS',
'Plugins': 'Plugins',
'Powered by': '基于下列技术构建：',
...
'Timestamp': '时间戳',
'to complete your order, send ': 'to complete your order, send ',
'trade history': '成交记录',
'TradeType': 'TradeType',
'transaction history': '交易记录',
'transfer ASSET if you want to sell MARKET, others for buy MARKET.': '发送ASSET会下MARKET卖单，其它任何资产均为MARKET买单。',
'Trx ID': '交易号',
'Twitter': 'Twitter',
'Type': '类型',
...
'with price limit': '限价',
'withdraw': '提现',
'Withdraw amount': '获取数量',
'Withdraw currency': '获取资产',
'Working...': 'Working...',
'YES': '是',
'You are successfully running web2py': '您已成功运行 web2py',
'you can get TRADE.BTC from': 'you can get TRADE.BTC from',
'you can get TRADE.BTC from <A href=http://blocktrades.us>blocktrades.us</A>': 'you can get TRADE.BTC from <A href=http://blocktrades.us>blocktrades.us</A>',
